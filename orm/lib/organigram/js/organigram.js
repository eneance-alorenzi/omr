class TreeChart {
    ...
    */
        ...
        attrs.data = d3.hierarchy(attrs.rawData)
                ...
                switch (attrs.template) {
                    ...
                    case 'full' :
                        ...
                        d._criticalText = d.criticalExpert ? '<span style="color: blue; font-weight: bolder;">*</span>' : '';
    ...
    exportImage() {
        ...
        // mask useless
        attrs.svg.selectAll('.node-button-update').style('opacity', 0);
        attrs.svg.selectAll('.node-button-close').style('opacity', 0);
        attrs.svg.selectAll('.node-button-g').style('opacity', 0);
        attrs.svg.selectAll('.node-image-group').style('opacity', 0);
        ...
        // mask useless
        attrs.svg.selectAll('.node-button-update').style('opacity', 1);
        attrs.svg.selectAll('.node-button-close').style('opacity', 1);
        attrs.svg.selectAll('.node-button-g').style('opacity', 1);
        attrs.svg.selectAll('.node-image-group').style('opacity', 1);
